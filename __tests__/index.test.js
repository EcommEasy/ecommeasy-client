import EcommeasyClient from '../src/index';
...
test('api structure', () => {
	const api = new EcommeasyClient(API_CREDENTIALS);
...
test('ajax structure', () => {
	const api = new EcommeasyClient(AJAX_CREDENTIALS);
...
test('static methods', () => {
	expect(typeof EcommeasyClient.authorize).toBe('function');
	expect(typeof EcommeasyClient.authorizeInWebStore).toBe('function');
});
